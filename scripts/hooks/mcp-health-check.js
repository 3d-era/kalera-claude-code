...
// 401/403 count as healthy for HTTP MCP servers: OAuth-protected servers correctly
// reject the anonymous probe, while the real call carries the Claude session's
// stored OAuth token. A blocked probe here would hide a perfectly working server.
const HEALTHY_HTTP_CODES = new Set([200, 201, 202, 204, 301, 302, 303, 304, 307, 308, 401, 403, 405]);
